...
{#snippet dot()}
  <svg viewBox="0 0 100 100" aria-hidden="true">
    <circle cx="50" cy="50" r="41" fill="var(--color-bg-base)" />
    <circle cx="50" cy="50" r="36" fill="#facc15" />
  </svg>
{/snippet}
...
<footer>
  <div>
    ...
    <div>
      <small>
        Set in <b>Switzer</b> and <b data-serif>Literata</b> &bull; Built with
        <b>{@render svelteMark()}SvelteKit</b>
      </small>
  ...
  footer {
    ...
    > div:last-child {
      ...
      span {
        ...
        border-inline-start: 1.5px solid var(--color-border-base-secondary);
      }
    }
